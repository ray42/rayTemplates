...
//=========================================================================
 ...
 setup()
 {
  ...
  // Set the mesh if this is the master preconditioner. If this is a
  // subsidiary block preconditioner, we get info from the master 
...
//   }
  ...
  if (F_preconditioner_is_block_preconditioner)
   {
//     pause("F is a block preconditioner!"); 
